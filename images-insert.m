...
- (IBAction)submit:(id)sender {
    ...
    NSURL *url=[NSURL URLWithString:@"http://localhost/tifflunbox/insert-images.php"];
    
    NSString *strbody=[NSString stringWithFormat:@"sp_id=%@&images=%@",spid,base64];
